...
const RTCMultiConnection = function (roomid, forceOptions) {
    function SocketConnection(connection, connectCallback) {
        ...
        function onMessageEvent(message) {
            ...
            if (message.message.streamSyncNeeded &&
    ...
    function MultiPeers(connection) {
        ...
        this.addNegotiatedMessage = function (message, remoteUserId) {
            ...
            if (message.enableMedia) {
                ...
                if (message.userPreferences.isDataOnly &&
        ...
        this.shareFile = function (file, remoteUserId) {
            ...
            connection.fbr.readAsArrayBuffer(file, function (uuid) {
                ...
                chunkSize: DetectRTC.browser.name === "Firefox"
                    ? 15 * 1000
        ...
        this.onDataChannelMessage = function (message, remoteUserId) {
            textReceiver.receive(JSON.parse(message), remoteUserId, connection.peers[remoteUserId]
                ? connection.peers[remoteUserId].extra
                : {});
        };
    ...
    function isAudioPlusTab(connection, audioPlusTab) {
        ...
        if (typeof audioPlusTab === "undefined" &&
            connection.session.audio &&
    ...
    function PeerInitiator(config) {
        ...
        if (connection.session.audio == "two-way" ||
            connection.session.video == "two-way" ||
            connection.session.screen == "two-way") {
            defaults.sdpConstraints = setSdpConstraints({
                OfferToReceiveAudio: connection.session.audio == "two-way" ||
                    (config.remoteSdp &&
                        config.remoteSdp.remotePeerSdpConstraints &&
    ...
    (function (connection) {
        ...
        function joinRoom(connectionDescription, cb) {
            connection.socket.emit("join-room", {
                ...
                extra: connection.extra,
                password: typeof connection.password !== "undefined" &&
        ...
        connection.onbeforeunload = function (arg1, dontCloseSocket) {
            ...
            connection.peers.getAllParticipants().forEach(function (participant) {
                ...
                if (connection.peers[participant] &&
        ...
        connection.invokeGetUserMedia = function (localMediaConstraints, callback, session) {
            ...
            getUserMediaHandler({
                onGettingLocalMedia: function (stream) {
                    ...
                    if (videoConstraints) {
                        if (videoConstraints.mediaSource ||
        ...
        connection.setStreamEndHandler = function (stream, isRemote) {
            ...
            stream.addEventListener(streamEndedEvent, function () {
                ...
                if (streamEvent.userid === connection.userid &&
        ...
        if (navigator && navigator.connection && navigator.connection.type) {
            ...
            if (connection.isLowBandwidth) {
                ...
                if (connection.mediaConstraints.audio &&
                    connection.mediaConstraints.audio.optional &&
...
//# sourceMappingURL=RTCMultiConnection.js.map