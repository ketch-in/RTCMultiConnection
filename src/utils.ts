...
export function fireEvent(obj, eventName, args) {
...
export function setHarkEvents(connection, streamEvent) {
...
export function setMuteHandlers(connection, streamEvent) {
  if (
    !streamEvent.stream ||
    !streamEvent.stream ||
...
export function getRMCMediaElement(stream, callback, connection) {
...
export function listenEventHandler(eventName, eventHandler) {
  window.removeEventListener(eventName, eventHandler);
  window.addEventListener(eventName, eventHandler, false);
}

export function removeNullEntries(array) {
  var newArray = [];
...
export function isData(session) {
...
export function isAudioPlusTab(connection, audioPlusTab) {
...
export function getAudioScreenConstraints(screen_constraints) {
  if (DetectRTC.browser.name === "Firefox") {
    return true;
  }
...
export function getTracks(stream, kind) {
...
export function isUnifiedPlanSupportedDefault() {
