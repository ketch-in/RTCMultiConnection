...
import MultiPeers from "./MultiPeersHandler";
...
import getUserMediaHandler from "./getUserMediaHandler";
...
// import FileSelector from "./FileSelector"; // <-- 요건 선택 사항..
...
function getStreamInfoForAdmin(connection) {
  try {
...
function connectSocket(connection, connectCallback) {
...
const RTCMultiConnection = function (roomid, forceOptions) {
  ...
  mPeer.onNegotiationNeeded = function (message, remoteUserId, callback) {
    ...
    connectSocket(connection, function () {
  ...
  function joinRoom(connectionDescription, cb) {
    connection.socket.emit(
      "join-room",
      {
        ...
        streams: getStreamInfoForAdmin(connection),
        extra: connection.extra,
        password:
  ...
  connection.connectSocket = function (callback) {
    connectSocket(connection, callback);
  };
