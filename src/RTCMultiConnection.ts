...
import { FileBufferReader, FileSelector } from "./FileBufferReader";
...
const RTCMultiConnection = function (roomid, forceOptions) {
  ...
  function isAudioPlusTab(connection?: any, audioPlusTab?: any) {
    ...
    if (typeof audioPlusTab === "boolean") {
      return true;
    }
  ...
  function getUserMediaHandler(options) {
    ...
    function streaming(stream?: any, returnBack?: any) {
    ...
    if (currentUserMediaRequest.streams[idInstance]) {
      ...
      if (typeof navigator.mediaDevices === "undefined") {
        ...
        var getUserMediaFailure: any = function () {};
  ...
  var StreamsHandler = (function () {
    ...
    return {
      ...
      onSyncNeeded: function (streamid, action, type?: any) {},
    };
  })();
  ...
  class TextReceiver {
    ...
    receive(data, userid, extra) {
      ...
      if (data.last) {
        var message = this.content[uuid].join("");
        if (data.isobject) {
        ...
        if (this.connection.autoTranslateText) {
          e.original = e.data;
          this.connection.Translator.TranslateText(
            e.data,
  ...
  var TextSender = {
    send: function (config) {
      ...
      function sendText(textMessage?: any, text?: any) {
        var data: any = {
          type: "text",
          uuid: uuid,
    ...
    connection.openOrJoin = function (roomid, callback) {
      ...
      connection.checkPresence(roomid, function (isRoomExist, roomid) {
        if (isRoomExist) {
          ...
          var localPeerSdpConstraints: any = false;
          var remotePeerSdpConstraints: any = false;
